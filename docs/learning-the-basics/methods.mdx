...
| type        | [native](data-types#native) \| [extended](data-types#extended) \| [Type](custom-types) \| ref.[Type](#Types) | Required    | The data type of this parameter&lt;br /&gt;&lt;br /&gt;Can reference imported CIDLs in the form of `ref.type_name`, where `ref` is the value set in the [imports](imports) |
