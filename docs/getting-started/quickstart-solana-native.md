...
Welcome to your first Solana Native smart contract experience using the Código platform.  
...
```txt
yes generate this code with rust native
```

<img src="/img/yes_rust.png" alt="Native selection" style={{ width: "375px" }} />

Once selected, your program is ready with all the files generated! 🎉

<img src="/img/counter_code_native.png" alt="counter" style={{ width: "375px" }} />
...
<img src="/img/counter_review_native.png" alt="counter" style={{ width: "500px" }} />
...
cd <repo_name>
cargo build-sbf
solana program deploy target/deploy/<repo-name>
```
